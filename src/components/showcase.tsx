      ...
      <div className="showcase-row">
        ...
        <div className="showcase-right">
          ...
          <div className="overlay-div showcase-description">
            ...
            <p>Team Rocket</p>
            <p>
              In this survival strength game, players must scavenge a ruined
      ...
      <div className="showcase-row second-row">
        <div className="showcase-left">
          ...
          <div className="overlay-div showcase-description">
            ...
            <p>Team Magma</p>
            <p>
              A rhythm-based action game about a Walkman wielding rebel fighting
        ...
        <div className="showcase-right">
          <div className="image-wrapper">
            ...
            <div className="overlay-div showcase-description">
              ...
              <p>Team Aqua</p>
              <p>
                You and your mythical creatures need a new place to live when
